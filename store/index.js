...
export const mutations = {
  setOnboarded(state, value) {
    ...
    this.$auth.$storage.setUniversal("onboarded", value);
    console.log("onboarded updated");
  },
  setResendCode(state, value) {
    state.resendCode = value;
    console.log("resend Code updated");
  },
};
export const actions = {
  async nuxtServerInit({ commit, dispatch, redirect }, { req }) {
    ...
    const onb = await this.$auth.$storage.getUniversal("onboarded");
    commit("setOnboarded", onb);
